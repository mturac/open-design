...
export const ko: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'Anthropic URL 유형',
  'settings.anthropicBaseUrlModeRoot': 'API 루트(/v1/messages 추가)',
  'settings.anthropicBaseUrlModeMessages': '전체 Messages endpoint',
  'settings.anthropicBaseUrlModeHint':
    '표준 Anthropic 호환 제공자에는 API 루트를 사용하세요. 제공자가 전체 Messages URL을 이미 제공하는 경우에만 전체 endpoint를 선택하세요.',
