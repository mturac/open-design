...
export const zhCN: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'Anthropic URL 类型',
  'settings.anthropicBaseUrlModeRoot': 'API root（自动附加 /v1/messages）',
  'settings.anthropicBaseUrlModeMessages': '完整 Messages endpoint',
  'settings.anthropicBaseUrlModeHint':
    '标准 Anthropic 兼容提供方请使用 API root。只有在提供方已给出完整 Messages URL 时，才选择完整 endpoint。',
