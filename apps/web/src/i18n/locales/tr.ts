...
export const tr: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'Anthropic URL turu',
  'settings.anthropicBaseUrlModeRoot': 'API koku (/v1/messages ekler)',
  'settings.anthropicBaseUrlModeMessages': 'Tam Messages endpoint',
  'settings.anthropicBaseUrlModeHint':
    'Standart Anthropic uyumlu saglayicilar icin API kokunu kullanin. Tam endpointi yalnizca saglayiciniz zaten eksiksiz Messages URL verdiginde secin.',
