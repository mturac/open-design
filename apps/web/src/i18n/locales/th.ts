...
export const th: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'ประเภท URL ของ Anthropic',
  'settings.anthropicBaseUrlModeRoot': 'ราก API (เพิ่ม /v1/messages)',
  'settings.anthropicBaseUrlModeMessages': 'Messages endpoint แบบเต็ม',
  'settings.anthropicBaseUrlModeHint':
    'ใช้ราก API สำหรับผู้ให้บริการมาตรฐานที่เข้ากันได้กับ Anthropic เลือก endpoint แบบเต็มเฉพาะเมื่อผู้ให้บริการให้ URL Messages แบบเต็มมาแล้วเท่านั้น',
