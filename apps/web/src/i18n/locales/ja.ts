...
export const ja: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'Anthropic URL タイプ',
  'settings.anthropicBaseUrlModeRoot': 'API ルート（/v1/messages を追加）',
  'settings.anthropicBaseUrlModeMessages': '完全な Messages endpoint',
  'settings.anthropicBaseUrlModeHint':
    '標準の Anthropic 互換プロバイダーでは API ルートを使用します。プロバイダーが完全な Messages URL を提供している場合のみ、完全な endpoint を選択してください。',
