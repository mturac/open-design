...
export const pl: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'Typ URL Anthropic',
  'settings.anthropicBaseUrlModeRoot': 'Root API (dodaje /v1/messages)',
  'settings.anthropicBaseUrlModeMessages': 'Pelny endpoint Messages',
  'settings.anthropicBaseUrlModeHint':
    'Uzyj root API dla standardowych dostawcow zgodnych z Anthropic. Pelny endpoint wybierz tylko wtedy, gdy dostawca podaje juz kompletny URL Messages.',
