...
export const de: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'Anthropic-URL-Typ',
  'settings.anthropicBaseUrlModeRoot': 'API-Root (fuegt /v1/messages an)',
  'settings.anthropicBaseUrlModeMessages': 'Vollstaendiger Messages-Endpunkt',
  'settings.anthropicBaseUrlModeHint':
    'Verwenden Sie API-Root fuer standardmaessige Anthropic-kompatible Anbieter. Waehlen Sie den vollstaendigen Endpunkt nur, wenn Ihr Anbieter bereits die komplette Messages-URL vorgibt.',
