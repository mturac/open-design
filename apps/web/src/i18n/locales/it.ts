...
export const it: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'Tipo di URL Anthropic',
  'settings.anthropicBaseUrlModeRoot': 'Root API (aggiunge /v1/messages)',
  'settings.anthropicBaseUrlModeMessages': 'Endpoint Messages completo',
  'settings.anthropicBaseUrlModeHint':
    'Usa la root API per i provider standard compatibili con Anthropic. Scegli l’endpoint completo solo quando il provider fornisce gia l’URL Messages completo.',
