...
export const ar: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'نوع عنوان URL لـ Anthropic',
  'settings.anthropicBaseUrlModeRoot': 'جذر API (يضيف /v1/messages)',
  'settings.anthropicBaseUrlModeMessages': 'نقطة نهاية Messages الكاملة',
  'settings.anthropicBaseUrlModeHint':
    'استخدم جذر API للموفرين القياسيين المتوافقين مع Anthropic. اختر نقطة النهاية الكاملة فقط عندما يوفر الموفر عنوان Messages الكامل بالفعل.',
