...
export const id: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'Jenis URL Anthropic',
  'settings.anthropicBaseUrlModeRoot': 'Root API (tambahkan /v1/messages)',
  'settings.anthropicBaseUrlModeMessages': 'Endpoint Messages lengkap',
  'settings.anthropicBaseUrlModeHint':
    'Gunakan root API untuk penyedia standar yang kompatibel dengan Anthropic. Pilih endpoint lengkap hanya jika penyedia sudah memberi URL Messages lengkap.',
