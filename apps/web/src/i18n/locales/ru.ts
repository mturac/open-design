...
export const ru: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'Тип URL Anthropic',
  'settings.anthropicBaseUrlModeRoot': 'Корень API (добавляет /v1/messages)',
  'settings.anthropicBaseUrlModeMessages': 'Полный endpoint Messages',
  'settings.anthropicBaseUrlModeHint':
    'Используйте корень API для стандартных Anthropic-совместимых провайдеров. Выбирайте полный endpoint только если провайдер уже выдает полный URL Messages.',
