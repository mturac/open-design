...
export const ru: Dict = {
  ...
  'settings.skillsOverrideWarning':
    'Редактирование этого встроенного навыка создаст пользовательское переопределение. Встроенная запись будет скрыта из списка, пока вы не удалите переопределение. Продолжить?',
