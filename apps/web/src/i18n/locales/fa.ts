...
export const fa: Dict = {
  ...
  'settings.anthropicBaseUrlMode': 'نوع URL آنتروپیک',
  'settings.anthropicBaseUrlModeRoot': 'ریشه API (افزودن /v1/messages)',
  'settings.anthropicBaseUrlModeMessages': 'نقطه پایانی کامل Messages',
  'settings.anthropicBaseUrlModeHint':
    'برای ارائه‌دهندگان سازگار با آنتروپیک از ریشه API استفاده کنید. فقط وقتی ارائه‌دهنده شما URL کامل Messages را داده است، نقطه پایانی کامل را انتخاب کنید.',
